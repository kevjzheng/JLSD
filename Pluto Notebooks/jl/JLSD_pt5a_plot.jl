...
# ╔═╡ 2f59ae33-de5d-4ec6-970c-14d3fad1c4d7
using Parameters, Observables

# ╔═╡ 5d341821-e1fe-4d68-98a3-1a453ca5397e
using Makie, GLMakie, ShortCodes

# ╔═╡ bc7560f5-b531-4252-864b-bb402edf7388
using PlutoUI

# ╔═╡ dbacfd95-3a4e-46f1-8384-34309fe72809
Resource(
	"https://docs.makie.org/v0.21/assets/4c067d1.Dp-3HtoW.png",
	width => 500
)

# ╔═╡ 6b332652-a2ac-46b3-94c8-2a10d5ac1eab
begin
f1, ax1, l1 = lines(0:10) #creates a new figure, along with the axis and line object
lines!(ax1, 10:-1:0)
hlines!(5, color=:green, linestyle=:dash) #no explicit axis given
f1
end

# ╔═╡ 26ff4f99-77d1-47a3-a0a9-25ffeab6b164
begin
f2 = Figure(size=(600,300));
ax2, l2 = lines(f2[1,1],randn(10))
lines!(Axis(f2[1,2]), randn(10))
lines!(ax2, randn(10))
f2
end

# ╔═╡ e84bb6ff-d992-4fd0-8f35-a8a0cb827165
begin
mutable struct Figz
	fig::Makie.Figure
	nrow::Int64
...
# ╔═╡ 54038020-2d94-11ef-158f-758a4b34e36f
md"""
# Building SerDes in Julia pt. 5A - Plotting and More
"""

# ╔═╡ 7f1d3e06-2b97-4087-931a-d589196b1ced
md"""
![Makie plots cover](https://user-images.githubusercontent.com/1010467/81500379-2e8cfa80-92d2-11ea-884a-7069d401e5d0.gif)
"""

# ╔═╡ 82a38e56-eba7-47f0-8ecb-cd7761cf6a33
md"""
...
# ╔═╡ b6e12ee6-ce7b-43eb-af89-85dc72896b01
md"""
In this notebook, I will briefly summarize what are the plotting options (yes, option with "s") in Julia, compare with MATLAB and Python's matplotlib, and why I think [Makie](https://docs.makie.org/v0.21/) might be the best option for our SerDes models （or the best overall in the long run）. At time same time, we will introduce some of the most powerful features in Julia, including multiple dispatch, struct as functions, Observables, etc.
"""

# ╔═╡ 21b2f999-b586-4ce9-a524-61ece9daab7d
md"""
## What makes MATLAB plots great
"""

# ╔═╡ 84cbe57f-33ee-4718-b30f-7fd98e23cec5
md"""
There are mainly three key things for any plotting package to be great

1. Publication-quality graphics (i.e., vector graphics, good color palletes, etc.)
2. Flexibility and ease of customization
3. Interactivity/user-friendly interface as a debug tool
"""

# ╔═╡ 5bb576ef-8dd6-480b-851a-0c5d65ad00ed
md"""
![matlab plots](https://circuit-artists.com/wp-content/uploads/2024/06/matlab_plots.png)
"""

# ╔═╡ 4f0c6619-5e46-43e4-b4dc-c0d7ee62a90e
md"""
...
# ╔═╡ 9bb522aa-ba91-4556-82e1-d2e9453d612b
md"""
```python
Figure(1); grid on
plot(x,y)
...
# ╔═╡ 0a9d3adf-2f93-4a17-938e-5a1306496088
md"""
...
![matlab figure](https://circuit-artists.com/wp-content/uploads/2024/06/matlab_figure.png)
"""

# ╔═╡ 2ca789ee-3d69-4f18-9c8a-56ff5ab4bc2a
md"""
### Matplotlib - the next best thing?
"""

# ╔═╡ 1ba4dd5f-173a-4046-b53e-76922f898ab9
md"""
...
# ╔═╡ 82c44c8c-1345-4a6e-9f9f-a9141321eb53
md"""
Python's ```matplotlib.pyplot``` has evolved to be almost a MATLAB twin in terms of plot varierty and command syntax, as shown in this example from [matplotlib's website](https://matplotlib.org/stable/tutorials/pyplot.html)
"""

# ╔═╡ f981835b-4e20-4421-81cd-daed9deb65b6
md"""
```python
...
# ╔═╡ fc0b8760-3ec1-437d-a028-3a7a23af804a
md"""
![pyplot example](https://matplotlib.org/stable/_images/sphx_glr_pyplot_010.png)
"""

# ╔═╡ 45ff5346-1ce5-4e78-9e07-5baa11eed31b
md"""
...
![pyplot_interactive](https://circuit-artists.com/wp-content/uploads/2024/06/pyplot_figure.png)
"""

# ╔═╡ f497be4f-8750-4aed-8c24-cf15193f1dea
md"""
...
# ╔═╡ b58f98f7-2763-482e-9dfc-d2769f50f85b
md"""
## State of Julia plots
"""

# ╔═╡ 9abb8c9c-7c9a-4efb-8d33-f855113c132d
md"""
...
Instead of creating something new that still mimics MATLAB (like ```pyplot```), Julia's default plot package, [Plots.jl](https://docs.juliaplots.org/latest/), adopts a unified plotting syntax BUT with options for different **backends**.
"""

# ╔═╡ 24ac4b51-f063-41bb-bc0a-c17df82f079f
md"""
A backend determins the engine behind plot generations, and each backend may differ in its features and capabilities. The available backends and their advantages are well summarized in the [official documentation.](https://docs.juliaplots.org/latest/backends/)

![julia_plot_backend](https://circuit-artists.com/wp-content/uploads/2024/06/julia_plots_backend.png)
"""

# ╔═╡ 9c86930b-5090-41d5-95de-59e2e1aad0f2
md"""
...
![julia_python_plot](https://circuit-artists.com/wp-content/uploads/2024/06/julia_pythonplot.png)
"""

# ╔═╡ c3dd5a45-abab-4e1d-abc8-9805590a70ad
md"""
To address the interactivity issue in ```pyplot```, [PlotlyJS](https://plotly.com/javascript/) is a great backend for the best zooming/panning exeperience (you know it's more user-friendly when it's powered by Javascript). It also comes with axis resizing and legend toggling too (note the y3 trace is grayed out).

![julia plotlyjs](https://circuit-artists.com/wp-content/uploads/2024/06/julia_plotlyjs.png)
"""

# ╔═╡ 97bdbdb1-220a-4007-95ef-6c7a868d6c04
md"""
...
# ╔═╡ e16cd846-10f6-4848-9dbe-49407285d1c5
md"""
### Makie - my choice for plotting in Julia
"""

# ╔═╡ 9521e56c-7a2a-4ad0-9e6b-455ac91c98bc
md"""
...
# ╔═╡ daddd078-747c-414a-86cf-e2137f6ae7bf
md"""
...
# ╔═╡ c2c03069-b7d6-4c5d-99ef-95a9505da1ed
md"""
...
# ╔═╡ d53a46f4-1e10-4fa2-a272-8e64268f79f7
md"""
### The "bad" about GLMakie (and how I "solve" it)
"""

# ╔═╡ d1eb92b6-2bba-4283-b6e4-c4042ca318dc
md"""
...
# ╔═╡ 66560f00-b8da-424f-8b5c-68b4d0668b54
md"""
...
A very Julian thing is to do is add ! to functions, so naturally every plotting function has a ! variant. The mutating ```lines!``` function takes an axis object, and draws onto the same axis without overwritting existing plots.
...
# ╔═╡ f81cf236-52bb-4595-af6a-bfa47785b59a
md"""
...
# ╔═╡ 2ff50e98-f67a-4fdb-8cba-46de5a218a7f
md"""
...
# ╔═╡ 28a7296b-3616-46bd-b679-7169565d99bd
md"""
### Figz
"""

# ╔═╡ b0517a52-f6cc-4768-a8a7-db088a5c8cd9
md"""
...
2. Seemlessly plots into subplots, but without explicitly creating ```Axis```
3. Only mutating plot functions are necessary (although the full Makie extensibility should still be available)
"""

# ╔═╡ 24d577e2-6101-4ad2-af84-fd1eba44c8b7
md"""
Let's explain the code block by block. ```Figz``` is just a wrapper struct that contains the Makie figure's ```Figure``` and ```Axis``` objects. As of now, ```Figz``` assumes the simplest use case of subplots, each containing a single axis. 
The constructor takes optional number of row (```nr```) and number of column (```nc```) arguments to pre-define the subplot grid, but it's not that important since Makie does a great job figuring out the layout as we go. The keyword args for Makie's figure creation can also be directly passed through ```kwargs```.

Each figure window can take an optional name and enable [data inspector](https://docs.makie.org/v0.21/explanations/inspector) (GLMakie will show data points as mouse move over curves). Internally, all axes are generated and stored in a Matrix. We will then simply access these axes through a simpler interface.
"""

# ╔═╡ 0f4911fc-680a-41a5-8d38-539836766743
md"""
```Julia
mutable struct Figz
	fig::Makie.Figure
...
# ╔═╡ db841023-8f75-41cd-9042-7496343598e8
md"""
...
# ╔═╡ 845b3e39-3cff-4406-a694-cd3bb70ddf73
md"""
```Julia
function (figz::Figz)()
	current_figure!(figz.fig)
...
# ╔═╡ 2f751eec-4dae-4050-aaf2-5787a9f2eb26
md"""
!!! info "Julia tips"
...
# ╔═╡ 24dcb2e7-0e8e-4126-9aea-3273c5961839
md"""
...
# ╔═╡ a6069eae-26f8-49fc-bcdc-3c0554b4c282
md"""
```julia
function (figz::Figz)(r=1,c=1)
	nrow = figz.nrow
...
# ╔═╡ f5bec5b1-61f6-42c7-ad65-76c6531f729a
md"""
...
# ╔═╡ 0029a3d5-3e0a-4c8b-8c17-229bd07798fa
begin #Note only ! functions are necessary
ftest = Figz()
lines!(randn(10)) #plots to the default [1,1] axis
lines!(ftest(1,2),randn(10))  #creates and plots in the [1,2] position. The syntax is now more intuitive

ftest() #focus back on the default [1,1] axis
lines!(-0.9:.2:0.9)
hlines!(ftest(1,1), 0, color=:green)
ftest().title = "Figz!"

ftest(1,2) #focus to the [1,2] axis
lines!(0.9:-.2:-0.9)
#axis property can be accessed through the struct "function" as well
ftest(1,2).xlabel = "x"   
ftest(1,2).ylabel = "y"
	
ftest.fig #comment this line to see the pop-up window (make sure Julia and Makie is installed). It's only used so that the plot shows up in the notebook
end

# ╔═╡ 18c6cd24-801d-4109-9938-86e685d764c5
md"""
!!! infor "Makie Tips"
...
# ╔═╡ fe00b17c-8fe6-4a2d-be23-fd688b7731a3
md"""
Another thing I want to highlight that's possible in Julia, but not so easily (or just impossible) in other language is **multiple dispatch**. Without going into too many details, multiple dispatch allows us to override and define existing functions for our own data types. It's different from [operator overloading](https://www.programiz.com/python-programming/operator-overloading) (like in C++ or Python) where the function has to be called from an object. In Julia, the right function with the right argument types will be called automatically.
"""

# ╔═╡ f710c6a2-4667-4a37-ac96-b7ef700616d3
md"""
...
# ╔═╡ 7053aff6-aecb-4df9-a96d-90abd56927de
md"""
```julia
Base.getindex(x::Figz, args...) = (
	return getindex(x.fig, args...)
...
# ╔═╡ 386cd924-766f-48c7-acf1-37d228c6db6a
md"""
So in conclusion, Makie's biggest problem for me is resolved with some small custom code. Use the playaround below to experiment with the ```Figz``` struct and its interface.
"""

# ╔═╡ 500cf225-15c4-4fd6-9a92-7da74f9b5b1a
#play around with Figz here! New windows will pop up everytime you run this code cell
begin
fkz = Figz(1,2, datainspector=true, backgroundcolor = :white, size = (800, 600));

fkz(1,1).title = "test title"
fkz(1,1).yticklabelcolor = :blue
lines!(fkz(1,1), randn(100), color=:blue);


lines!(fkz(2,1), randn(200), label="line1");
lines!(randn(200), label="line2"); #once [2,1] is focused, we can keep plotting
axislegend() #legend will also be created for the focused axis
	
linkxaxes!(fkz(2,1), fkz(1,1));

scatter!(fkz(2,3), randn(10))
stem!(fkz(1,3), randn(15));	
...
fkz()
lines!(randn(10), color =:green)

fkz(1,2)
scatterlines!(randn(10), color =:black)

ax_new = Axis(fkz[2,2]) #I can still create a new axis the Makien way. Figz behaves the same as a Makie Figure because we overrode the getindex function. Note that this creation doesn't update Figz object's internal axes matrix. Only do this if needs twin axis (Maybe will be a built-in capability of Figz in the future)

fkz.fig #comment this two lines to see pop-up windows
end

# ╔═╡ 29f439f0-910f-42a9-9562-9b5bf0099fc3
md"""
### The GOOD about Makie - ```Observables```
"""

# ╔═╡ c7d461c1-62c0-41b6-a350-b140fd933aa8
md"""
The one feature that ultimately made me stick with Makie is its compatibility with ```Observables```. As a preview, please first check out the demo in this [video](https://www.youtube.com/watch?v=L-gyDvhjzGQ&t=12s&ab_channel=JuliaDynamics). 
"""

# ╔═╡ 7c138098-3aeb-46a2-868a-4efa58b3a2e1
ShortCodes.YouTube("L-gyDvhjzGQ",0,0)

# ╔═╡ cbdd5793-efe8-4a06-8cb2-a7dfe61fd576
md"""
...
# ╔═╡ 2597b3c6-b215-4652-9271-969f01626635
md"""
...
# ╔═╡ cbb7b0e5-d0df-40bf-9fc0-6ffd352f24d0
Resource(
	"https://juliadatascience.io/im/JDS_cheatsheet_cairomakie_.svg",
	:alt => "makie cheatsheet 2d",
	:width => 600
)

# ╔═╡ 0fa4c585-39a5-4daf-80e1-ddc89220c9c3
Resource(
	"https://juliadatascience.io/im/JDS_cheatsheet_glmakie_.png",
	:alt => "makie cheatsheet 3d",
	:width => 600
)
...
manifest_format = "2.0"
project_hash = "3861eb178f010637747be0e42aca6c88b2a5b164"
